...
type ActionState = { error: FieldErrors } | undefined
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-surface-1">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center mb-8">
          <Image src="/logo.png" alt="Logo" width={270} height={270} className="object-contain" />
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
          <h1 className="text-2xl font-bold text-slate-900 mb-1">Create your account</h1>
          <p className="text-sm text-slate-500 mb-8">Start managing tasks with your team</p>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              {errors?.full_name && (
                <p className="text-xs text-red-500">{errors.full_name[0]}</p>
              )}
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl btn-gradient text-white font-semibold text-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] mt-2"
            >
              {isPending ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            ...
            <Link href="/login" className="text-brand-600 hover:text-brand-500 font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
